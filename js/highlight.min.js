...
strings:i,keywords:u}}}})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
relevance:0}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
contains:[c]}]}}})());hljs.registerLanguage("applescript",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function t(...t){
...
},...a],illegal:/\/\/|->|=>|\[\[/}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
name:"Shell Session",aliases:["console","shellsession"],contains:[{
className:"meta",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
